...
class Instruction:
    ...
    def get_frame(self, var):
        if var.find('GF@') != -1:
            ...
            if self.TF is None:
                exit_program(Status.FRAME_NOT_EXIST_ERR, "Attempted to access a temporary frame without creating it first.")
            return self.TF
        elif var.find('LF@') != -1:
            if len(self.LF) == 0:
                exit_program(Status.FRAME_NOT_EXIST_ERR, "Attempted to access a local frame without creating it first.")
            return self.LF[0]
        else:
    ...
    def check_relation_args(self, arg1_type, arg1_val, arg2_type, arg2_val, instruction):
        ...
        if arg1_type != arg2_type:
            exit_program(Status.MISMATCHED_TYPES_ERR, f'Expected same types of operands in {instruction} instruction.')
...
# The actual interpretation of IPPcode23 instruction set follows
    def do_move(self):
        ...
        if value1 is None or type1 is None:
            exit_program(Status.MISSING_VALUE_ERR, f'Var {self.op2} has to be set before assingning.')
    ...
    def do_return(self):
        if len(self.call_stack) == 0:
            exit_program(Status.MISSING_VALUE_ERR, "Tried to use RETURN without calling.")

        return int(self.call_stack.popleft())

    def do_pushs(self):
        value1, type1, value2, type2 = self.get_frame_value_types(self.op1, self.op1_type, None, None)

        if value1 is None or type1 is None:
            exit_program(Status.MISSING_VALUE_ERR, f'Variable {self.op1} not set in PUSHS.')
    ...
    def do_add(self):
        ...
        self.check_arithmetic_args(type1, value1, type2, value2, 'ADD')
    ...
    def do_mul(self):
        ...
        self.check_arithmetic_args(type1, value1, type2, value2, 'MUL')
    ...
    def do_sub(self):
        ...
        self.check_arithmetic_args(type1, value1, type2, value2, 'SUB')
    ...
    def do_idiv(self):
        ...
        self.check_arithmetic_args(type1, value1, type2, value2, 'IDIV')
    ...
    def do_lt(self):
        ...
        self.check_relation_args(type1, value1, type2, value2, 'LT')
    ...
    def do_gt(self):
        ...
        self.check_relation_args(type1, value1, type2, value2, 'GT')
    ...
    def do_eq(self):
        ...
        self.check_relation_args(type1, value1, type2, value2, 'EQ')
    ...
    def do_and(self):
        ...
        self.check_logical_args(type1, value1, type2, value2, 'AND')
    ...
    def do_or(self):
        ...
        self.check_logical_args(type1, value1, type2, value2, 'OR')
    ...
    def do_not(self):
        ...
        self.check_logical_args(type1, value1, None, None, 'NOT')
    ...
    def do_write(self):
        ...
        if value1 is None:
            exit_program(Status.MISSING_VALUE_ERR, f'Can not write an uninitialized symbol {self.op1}')
    ...
    def do_jumpifeq(self):
        ...
        self.check_jump_args(type1, value1, type2, value2, 'JUMPIFEQ')
    ...
    def do_jumpifneq(self):
        ...
        self.check_jump_args(type1, value1, type2, value2, 'JUMPIFNEQ')
...
# calls the corresponding function based on the opcode and returns the next order
    def execute(self):
        ...
        if self.opcode == "MOVE":
            ...
            order = self.do_jumpifeq()
        elif self.opcode == "JUMPIFNEQ":
            order = self.do_jumpifneq()
